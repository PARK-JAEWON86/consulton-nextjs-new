...
import { MessageCircle, Mic, Video, VideoOff, Monitor, MonitorOff, Phone, Paperclip, Users, Clock, User, Send } from "lucide-react";
...
export default function VideoPage() {
  ...
  // 상담 시작 관련 상태
  const [showConsultationStartModal, setShowConsultationStartModal] = useState(false);
  ...
  const handleToggleScreenShare = () => {
    setUserControls(prev => ({ ...prev, isScreenSharing: !prev.isScreenSharing }));
  };
