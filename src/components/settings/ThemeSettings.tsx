          ...
          {themeOptions.map((option) => {
            ...
            return (
              ...
              >
                ...
                <p className={`text-sm text-left ${isActive ? 'text-blue-700' : 'text-gray-600'}`}>
                  {option.description}
                </p>
                <div className={`mt-3 w-full h-16 rounded border ${option.preview}`}></div>
                {isActive && (
            ...
            return (
              ...
              >
                <div className="text-center">
                  <div className={`w-full h-8 rounded mb-2 ${scheme.primary}`}></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {fontSizes.map((size) => {
            ...
            return (
              ...
              >
                <div className="text-center">
                  <div className={`${size.preview} font-medium mb-2 ${isActive ? 'text-blue-900' : 'text-gray-900'}`}>
                    {size.label}
                  </div>
